classdef imfilter_tutorials_full_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.UIFigure.Position = [100 100 1008 450];
            app.UIFigure.Name = 'MATLAB App';

            % Create UIAxesOriginal
            app.UIAxesOriginal = uiaxes(app.UIFigure);
            ...
            app.UIAxesOriginal.Position = [25 79 300 300];

            % Create UIAxesFiltered
            app.UIAxesFiltered = uiaxes(app.UIFigure);
            ...
            app.UIAxesFiltered.Position = [324 79 300 300];

            % Create UIAxesKernel
            app.UIAxesKernel = uiaxes(app.UIFigure);
            ...
            app.KernelTypeDropDown.Position = [728 367 100 22];
            app.KernelTypeDropDown.Value = 'Disk';

            % Create ParametersPanel
            app.ParametersPanel = uipanel(app.UIFigure);
            app.ParametersPanel.Enable = 'off';
            app.ParametersPanel.Title = 'Parameters';
            app.ParametersPanel.Position = [646 31 163 323];
            ...
            app.PaddingOptionsButtonGroup = uibuttongroup(app.UIFigure);
            ...
            app.PaddingOptionsButtonGroup.Position = [833 248 123 106];
            ...
            app.OutputSizeButtonGroup = uibuttongroup(app.UIFigure);
            ...
            app.OutputSizeButtonGroup.Position = [833 164 123 77];
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = imfilter_tutorials_full_exported
